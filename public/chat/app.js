...
function render(role, content) { const el = document.createElement('div'); el.className = `bubble ${role}`; el.textContent = content; messages.append(el); messages.scrollTop = messages.scrollHeight; }
